...
We have trained the model with ResNet50 and got a training accuracy of 43% and validation accuracy of 41% which is not acceptable because the model is under-fitted. This error is may be because the model was trained on rgb images and the data set contains grascale images.  
